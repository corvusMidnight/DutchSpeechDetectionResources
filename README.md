...
|-----------|----------|-----------------|----------|----------|
| "jonatasgrosman/wav2vec2-large-xlsr-53-dutch"   | Fine-tuned facebook/wav2vec2-large-xlsr-53 on Dutch using the train and validation splits of Common Voice 6.1 and CSS10. | model |          |          |
| Generic   |          |                 |          |          |
| Generic   |          |                 |          |          |
| Generic   |          |                 |          |          |
| Generic   |          |                 |          |          |
